 ...
 * - use DHT11 temperature sensor with 'node-dht-sensor' Node.js module
 * - use DHT11 sensor example in the node-dht-sensor package
 * - use tas_sample created by I.-Y. Ahn, KETI
 * - need to install BCM2835 library and node-gyp first
 */
