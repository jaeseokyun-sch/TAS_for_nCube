 ...
 * - use ambient sound sensor with 'onoff' Node.js module
...
const sound = new Gpio(20, 'in', 'rising', {debounceTimeout: 1000});   // GPIO20 (pin): sound sensor digital output

sound.watch((err, value) => {
    // console.log('sound sensor detected: ' + value)
    if (tas_state == 'upload') {
        for (var i = 0; i < upload_arr.length; i++) {
            if (upload_arr[i].ctname == 'sound') {
                var cin = {
