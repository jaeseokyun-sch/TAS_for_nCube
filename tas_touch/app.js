 ...
 * - use capacitive touch sensor with 'onoff' Node.js module
...
const touch = new Gpio(20, 'in', 'rising', {debounceTimeout: 30});   // GPIO20 (pin): touch sensor input

touch.watch((err, value) => {
    // console.log('touch sensor pressed: ' + value)
    if (tas_state == 'upload') {
        for (var i = 0; i < upload_arr.length; i++) {
            if (upload_arr[i].ctname == 'touch') {
                var cin = {ctname: upload_arr[i].ctname, con: '1'};
